...
public class FlutterBeaconV2Plugin implements FlutterPlugin, ActivityAware, MethodCallHandler,
  ...
  private FlutterBeaconV2Scanner beaconScanner;
  private FlutterBeaconV2Broadcast beaconBroadcast;
  ...
  public FlutterBeaconV2Plugin() {
  }


  public static void registerWith(Registrar registrar) {
    final FlutterBeaconV2Plugin instance = new FlutterBeaconV2Plugin();
  ...
  private void setupChannels(BinaryMessenger messenger, Activity activity) {
    ...
    beaconScanner = new FlutterBeaconV2Scanner(this, activity);
    beaconBroadcast = new FlutterBeaconV2Broadcast(activity, iBeaconLayout);
