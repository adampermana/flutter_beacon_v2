...
class FlutterBeaconV2Broadcast {
  private static final String TAG = FlutterBeaconV2Broadcast.class.getSimpleName();
  private final BeaconTransmitter beaconTransmitter;

  FlutterBeaconV2Broadcast(Activity activity, BeaconParser iBeaconLayout) {
  ...
  void startBroadcast(Object arguments, @NonNull final MethodChannel.Result result) {
    ...
    final Beacon beacon = FlutterBeaconv2Utils.beaconFromMap(map);
